package SylSpace::Controller::Example;
...
print "\n\n here 1 \n\n";
  ...
  (my $course = standard( $self )) or return global_redirect($self);

  $self->render(template => 'AuthAuthenticator' );


print "\n\n here 2 \n\n";

#$self->global_redirect('/auth/authenticator');
